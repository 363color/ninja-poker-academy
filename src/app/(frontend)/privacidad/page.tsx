...
export default function PrivacidadPage() {
  return (
    <LegalLayout title="Política de Privacidad" toc={TOC}>
      <p>
        En <strong>[NOMBRE DE LA EMPRESA]</strong> nos comprometemos a proteger tu privacidad y a
        tratar tus datos personales con la máxima transparencia y seguridad, en cumplimiento del
        Reglamento General de Protección de Datos (RGPD) y demás normativa aplicable en{' '}
        <strong>[PAÍS]</strong>.
      </p>
      ...
      <section id="datos-recopilados">
        ...
        <ul>
          ...
          <li>
            ...
            y duración de la sesión, recopilados a través de cookies y herramientas de analítica.
          </li>
          <li>
            <strong>Datos de uso:</strong> contenido consultado, cursos accedidos e interacciones
            con la plataforma.
          </li>
          <li>
      ...
      <section id="finalidad">
        ...
        <ul>
          <li>
            <strong>Gestión de la cuenta de usuario</strong> — ejecución del contrato de servicio.
          </li>
          <li>
          ...
          <li>
            <strong>Envío de comunicaciones comerciales</strong> sobre cursos, torneos y novedades,
            únicamente con tu consentimiento expreso. Puedes retirar este consentimiento en
          ...
          <li>
            <strong>Verificación de edad</strong> para garantizar que los usuarios tienen al menos{' '}
            <strong>18</strong> años — cumplimiento legal y protección de menores.
          </li>
        </ul>
      </section>
      ...
      <section id="destinatarios">
        ...
        <ul>
          ...
          <li>
            <strong>Plataformas de analítica</strong> (como Google Analytics) para medir el uso del
            sitio.
          </li>
          <li>
      ...
      <section id="transferencias">
        ...
        <p>
          ...
          (EEE). En tales casos, garantizamos que las transferencias se realizan con las
          salvaguardas adecuadas previstas en la normativa vigente, como las cláusulas contractuales
          tipo aprobadas por la Comisión Europea o en virtud de una decisión de adecuación.
        </p>
      </section>
      ...
      <section id="conservacion">
        ...
        <ul>
          <li>
            <strong>Datos de cuenta:</strong> mientras la cuenta esté activa y durante los plazos
            legales aplicables tras su cancelación.
          </li>
          <li>
      ...
      <section id="derechos">
        ...
        <p>
          En virtud de la normativa de protección de datos aplicable, tienes los siguientes derechos
          sobre tus datos personales:
        </p>
        <ul>
          <li>
            <strong>Acceso:</strong> obtener confirmación sobre si tratamos tus datos y acceder a
            ellos.
          </li>
          <li>
          ...
          <li>
            <strong>Supresión («derecho al olvido»):</strong> solicitar la eliminación de tus datos
            cuando ya no sean necesarios para la finalidad que motivó su recogida.
          </li>
          <li>
            <strong>Limitación del tratamiento:</strong> solicitar que suspendamos el tratamiento en
        ...
        <p>
          ...
          Responderemos en el plazo máximo establecido por la normativa aplicable. Si consideras que
          el tratamiento de tus datos vulnera la normativa, tienes derecho a presentar una
      ...
      <section id="cambios">
        ...
        <p>
          ...
          significativos mediante un aviso destacado en el sitio web o, si corresponde, por correo
          electrónico. La fecha de la última revisión aparece al inicio de este documento.
        </p>
      </section>
