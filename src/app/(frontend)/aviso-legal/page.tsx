    ...
    <LegalLayout title="Aviso Legal" toc={TOC}>
      ...
      <section id="objeto">
        ...
        <p>
          ...
          relacionado con la estrategia, las matemáticas y la psicología del póker. La información
          publicada tiene carácter divulgativo y no constituye asesoramiento financiero, legal ni
          garantía de resultados en el juego.
        </p>
        <p>
          ...
          residencia del usuario; es responsabilidad de cada usuario verificar la legalidad de la
          práctica del juego en su jurisdicción.
        </p>
      </section>
      ...
      <section id="condiciones-acceso">
        ...
        <p>
          El acceso a este sitio web es libre y gratuito, salvo en lo que respecta a los servicios
          de pago. El usuario se compromete a hacer un uso adecuado del sitio, conforme a la ley, la
        ...
        <ul>
          ...
          <li>
            Realizar acciones que puedan dañar, inutilizar, sobrecargar o deteriorar el sitio o los
            sistemas informáticos de terceros.
          </li>
          <li>
            Intentar acceder sin autorización a sistemas, datos o áreas restringidas del sitio.
          </li>
          <li>
            Reproducir, distribuir o comunicar públicamente el contenido del sitio sin autorización
      ...
      <section id="propiedad-intelectual">
        ...
        <p>
          ...
          fotografías, ilustraciones, vídeos, logotipos, marcas, diseño gráfico, estructura y código
          fuente— son propiedad de <strong>[NOMBRE DE LA EMPRESA]</strong> o de sus cedentes, y se
          encuentran protegidos por la legislación vigente sobre propiedad intelectual e industrial.
        </p>
        <p>
          Se prohíbe expresamente la reproducción total o parcial del sitio, su comunicación
          pública, distribución, transformación o cualquier otro acto de explotación no autorizado
          por el titular. El incumplimiento de esta prohibición puede dar lugar a las acciones
      ...
      <section id="enlaces">
        ...
        <p>
          Este sitio puede contener hipervínculos a sitios web de terceros. Estos enlaces se ofrecen
          únicamente con fines informativos. <strong>[NOMBRE DE LA EMPRESA]</strong> no tiene
          control sobre el contenido, la política de privacidad ni las prácticas de dichos sitios, y
          no asume ninguna responsabilidad por ellos.
        </p>
        <p>
        ...
        <p>
          Si deseas enlazar a este sitio web desde el tuyo, hazlo de forma que no perjudique nuestra
          reputación ni induzca a error sobre la relación entre ambos sitios. Reservamos el derecho
          de solicitar la retirada de cualquier enlace que consideremos inapropiado.
        </p>
      </section>
      ...
      <section id="responsabilidad">
        ...
        <p>
          <strong>[NOMBRE DE LA EMPRESA]</strong> no garantiza la disponibilidad y continuidad del
          funcionamiento del sitio web. Tampoco garantiza la ausencia de errores en el contenido ni
          que el sitio esté libre de virus u otros elementos que puedan causar daños en los sistemas
          informáticos de los usuarios.
        </p>
        <p>
          El titular no será responsable, en la medida máxima permitida por la ley aplicable, de
          ningún daño o perjuicio —incluyendo daños económicos, pérdida de datos o interrupción de
          actividad— derivado del acceso o uso del sitio, de la imposibilidad de acceder a él, o de
          la confianza depositada en la información contenida en el mismo.
        </p>
      </section>
      ...
      <section id="ley">
        ...
        <p>
          ...
          relacionada con este sitio web, las partes se someten a la jurisdicción de los juzgados y
          tribunales competentes de <strong>[PAÍS]</strong>, con renuncia expresa a cualquier otro
          fuero que pudiera corresponderles, sin perjuicio de los derechos reconocidos a los
          consumidores por la normativa aplicable.
        </p>
      </section>
      ...
      <section id="contacto">
        <h2>8. Contacto</h2>
        <p>
          Para cualquier consulta relacionada con este Aviso Legal o con la actividad del sitio web,
